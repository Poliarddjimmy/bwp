...
const MessageList = ({ message, active, setMessageActive }) => {
  ...
  return (
    <div className="message">
      <div onClick={() => setMessageActive(message)} className={`cursor-pointer chat-list p-2 d-flex align-items-center justify-content-between ${active ? "active" : ""} rounded`}>
        <Image src={message.user.profile_pic} alt="avatar" className="avatar-lg rounded-circle border-danger" width="40" height="40" />
        <div className="w-80">
